...
export function NewsCard({ title, category, image, link }) {
  return (
    <Link href={link} className="group">
      <div className="relative w-full h-full overflow-hidden rounded-lg shadow-lg">
        ...
        {/* Content */}
        <div className="absolute bottom-0 left-0 z-10 p-4 bg-gradient-to-t from-black via-black/70 to-transparent text-white w-full">
          {/* Category */}
